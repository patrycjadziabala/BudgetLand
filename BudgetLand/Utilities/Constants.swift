...
struct Constants {
    ...
    static let fontColorOverview = "FontColorOverview"
    ...
    static let newCategoryName = "New Category"
    static let addNewCategory = "Add New Category"
    static let addCategoryBudget = "Add Category Budget"
    static let selectCategorySymbol = "Select Icon"
